if _G.CapoXNighthubV4Running then return end
_G.CapoXNighthubV4Running = true
...
CONFIG_FILE = "CapoXNighthubV4.json"
BAT_V2_HIT_DIST = 4.5
        ...
        for _, child in ipairs(parent:GetDescendants()) do
            if child:IsA("TextLabel") then
                if child.Text:find("discord.gg") or child.Text:find("Spd:") or child.Name == "DiscordText" or
                   child.Name == "CapoXNighthubV4SpeedIndicator" or child.Text:find("FPS") then
...
function setupSpeedIndicator(char)
    ...
    if not head then return end
    local oldBB = head:FindFirstChild("CapoXNighthubV4SpeedIndicator")
    if oldBB then oldBB:Destroy() end
    local bb = Instance.new("BillboardGui", head)
    bb.Name = "CapoXNighthubV4SpeedIndicator"
    ...
    discordLabel.Text = "Capo X Nighthub V4"
...
CUSTOM_FOV_BIND = "CapoXNighthubV4CustomFOV"
...
function buildGui()
    ...
    local old = game:GetService("CoreGui"):FindFirstChild("CapoXNighthubV4")
    if old then old:Destroy() end
    local pg = LP:FindFirstChild("PlayerGui")
    if pg then local o = pg:FindFirstChild("CapoXNighthubV4"); if o then o:Destroy() end end

    gui = Instance.new("ScreenGui")
    gui.Name = "CapoXNighthubV4"
    ...
    miniBtn.Text = "Capo X Nighthub V4"
    ...
    discordLabelTop.Text = "Capo X Nighthub V4"
...
function createMobilePanel()
    ...
    panel.Name = "CapoXNighthubV4MobilePanel"
